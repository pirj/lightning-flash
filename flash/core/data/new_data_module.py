...
from flash.core.data.new_data_pipeline import NewDataPipeline
...
from flash.core.data.preprocess_transform import PreTransform, DefaultPreTransform
...
class DataModule(pl.LightningDataModule):
    ...
    pre_transform_cls = DefaultPreTransform
    ...
    def __init__(
        ...
        post_transform: Optional[Postprocess] = None,
        ...
        self._postprocess: Optional[Postprocess] = post_transform
    ...
    @property
    def pre_transform(self) -> PreTransform:
        return self._pre_transform or self.pre_transform_cls()
    ...
    def data_pipeline(self) -> DataPipeline:
        return NewDataPipeline(self., self.pre_transform, self.postprocess)
